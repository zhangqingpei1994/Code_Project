...
void Robot_arm::track_head(Eigen::Vector4d & nose1,Eigen::Vector4d &nose2)
{
   ...
   movelpos(target(0,0), target(1,0), target(2,0), Rx, Ry, Rz, 0.1, 0.05);

   //ui->lineEdit_target_X->setText(QString::number(target(0,0), 10,4));
   //ui->lineEdit_target_Y->setText(QString::number(target(0,1), 10,4));
   //ui->lineEdit_target_Z->setText(QString::number(target(0,2), 10,4));
