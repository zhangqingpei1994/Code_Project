...
void MainWindow::on_pushButton_sendPosition_clicked()
{
    ...
    robot_ur5.movelpos(targetposition[0],targetposition[1],targetposition[2],targetposition[3],targetposition[4],targetposition[5],speed,acc);
}
