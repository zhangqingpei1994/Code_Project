...
class ERT{
public:              //原来的cascade_number = 10
        ERT(const int &cascade_number = 1, const int &tree_number = 500, const int &multiple_trees_number = 10, const int &tree_depth = 5, const int &feature_number_of_node = 20,
