...
void kfusion::cuda::depthTruncation(Depth& depth, float threshold)   //没调用
...
//==========================看过==================
void kfusion::cuda:: computeDists(const Depth& depth, Dists& dists, const Intr& intr)//Dists：  cuda::DeviceArray2D<unsigned short>
{
