...
class OpenNI2Interface : public CameraInterface
{
    public:
        ...
        class RGBCallback : public openni::VideoStream::NewFrameListener   //NewFrameListener ,就是这么用的,不能直观理解的花可以参考 http://www.mamicode.com/info-detail-1680619.html
        {
            public:
    ...
    private:
        ...
        ThreadMutexObject<int> latestRgbIndex;    //latestDepthIndex已经在基类CameraInterface中定义了
